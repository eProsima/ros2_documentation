...
* `ROS 2 Packages for PyTorch and TensorRT <https://github.com/NVIDIA-AI-IOT/ros2_torch_trt>`__: ROS 2 packages for classification and object detection tasks using PyTorch and NVIDIA TensorRT.
